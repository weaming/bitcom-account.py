...
if __name__ == '__main__':
    ...
    if mode == 'um':
        um_account = client.um_query_accounts()['data']
        um_account['details'] = [x for x in um_account['details'] if float(x['equity']) > 0]
        print(json.dumps(um_account, ensure_ascii=0, indent=2))
    elif mode == 'classic':
        # TODO: pretty print
